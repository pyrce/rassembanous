...
class HomeController {
    ...
    static getCategories(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //data = JSON.parse(data);
            console.log(data);
            let categories = yield prisma.categories.findMany({ skip: data.offset != null ? data.offset : undefined,
                take: data.limit });
    ...
    static submitQuestionnaire(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (data.id) {
                ...
                newQuestion = yield prisma.questionnaire.create({ data: {
            ...
            data.questions.forEach((element) => __awaiter(this, void 0, void 0, function* () {
                ...
                console.log(quest);
                if (quest.length > 0) {
                    yield prisma.questions.update({ data: { id_questionnaire: newQuestion.id,
                            question: element.question }, where: { id: quest[0].id } });
                }
                else {
                    yield prisma.questions.create({ data: {
