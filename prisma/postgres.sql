...
create sequence IF NOT EXISTS evenements_id_id_seq;
CREATE TABLE evenements (
 id integer NOT NULL DEFAULT nextval('evenements_id_id_seq'),
...
create sequence IF NOT EXISTS lieu_id_seq;
create table lieu(
 id integer NOT NULL DEFAULT nextval('lieu_id_seq'),
nomLieu varchar(30),
	PRIMARY KEY (id),
adresse varchar(255)
);
...
create sequence mediatype_id_seq;
create table mediaType(
 id integer NOT NULL DEFAULT nextval('mediatype_id_seq'),
	primary KEY(id),
libelle varchar(10)
);
...
create sequence IF NOT EXISTS event_user_id_seq;
...
create sequence IF NOT EXISTS partenaire_user_id_seq;
create table partenaire_user(
 id integer NOT NULL DEFAULT nextval('partenaire_user_id_seq'),
id_user int not null,
...
create sequence IF NOT EXISTS stands_id_seq;
create table stands(
 id integer NOT NULL DEFAULT nextval('stands_id_seq'),
nomStand varchar(30),
...
create sequence IF NOT EXISTS eventstand_id_seq;
create table event_stand(
 id integer NOT NULL DEFAULT nextval('eventstand_id_seq'),
id_event int not null,
...
create table questionnaire(
 id integer NOT NULL DEFAULT nextval('questionnaire_id_seq'),
id_event int,
	PRIMARY KEY (id),
...
create sequence IF NOT EXISTS question_user_id_seq;
create table question_user(
 id integer NOT NULL DEFAULT nextval('question_user_id_seq'),
id_user int,
id_question int,
stars float,
	PRIMARY KEY (id),
